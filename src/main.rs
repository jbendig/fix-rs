...
fn print_group(group: &HashMap<String,fix_rs::fix::TagValue>,depth: u8) {
...
fn print_tag_value(tag_value: &fix_rs::fix::TagValue,depth: u8) {
    match tag_value {
        &fix_rs::fix::TagValue::String(ref str) => println!("{}",str),
        &fix_rs::fix::TagValue::RepeatingGroup(ref repeating_group) => {
